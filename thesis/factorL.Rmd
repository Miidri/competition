...
VSS(dataL1[,-1:-2], n=10)
# 平行分析
fa.parallel(dataL1[,-1:-2], main= "Like")
```
...
scoresL <- cbind(scoresL, index)

ggplot(scoresL, aes(x=ML1, y=ML2, col=index)) +
  geom_point(size = 1)+
  scale_color_manual(values = c( "#ff0000","#0000ff","#ff99cc","#00cbcb"))
ggplot(scoresL, aes(x=ML1, y=ML3, col=index)) +
  geom_point(size = 1)+
  scale_color_manual(values = c( "#ff0000","#0000ff","#ff99cc","#00cbcb"))
ggplot(scoresL, aes(x=ML1, y=ML4, col=index)) +
  geom_point(size = 1)+
  scale_color_manual(values = c( "#ff0000","#0000ff","#ff99cc","#00cbcb"))
ggplot(scoresL, aes(x=ML2, y=ML3, col=index)) +
  geom_point(size = 1)+
  scale_color_manual(values = c( "#ff0000","#0000ff","#ff99cc","#00cbcb"))
ggplot(scoresL, aes(x=ML2, y=ML4, col=index)) +
  geom_point(size = 1)+
  scale_color_manual(values = c( "#ff0000","#0000ff","#ff99cc","#00cbcb"))
ggplot(scoresL, aes(x=ML3, y=ML4, col=index)) +
  geom_point(size = 1)+
  scale_color_manual(values = c( "#ff0000","#0000ff","#ff99cc","#00cbcb"))
```
...
grid.arrange(scoresL_MMp, scoresL_MUp, scoresL_FMp, scoresL_FUp,
             ncol = 2)
```
